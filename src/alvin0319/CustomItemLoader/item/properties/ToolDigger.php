...
interface ToolDigger
{
    ...
    const PICKAXE = [
        ...
        "minecraft:polished_andesite_stairs", "minecraft:mossy_stone_brick_stairs", "minecraft:smooth_red_sandstone_stairs", "minecraft:smooth_sandstone_stairs",
        "minecraft:end_brick_stairs", "minecraft:mossy_cobblestone_stairs", "minecraft:normal_stone_stairs", "minecraft:red_nether_brick_stairs", "minecraft:smooth_quartz_stairs",
        "minecraft:crimson_stairs", "minecraft:warped_stairs", "minecraft:polished_blackstone_brick_stairs", "minecraft:blackstone_stairs", "minecraft:polished_blackstone_stairs",
    ];
